...
import { AddBlocker, AddBlockerArgs, Attributes, AttributesArgs, Autograph, AutographArgs, BaseMasterEdition, BaseMasterEditionArgs, BaseRoyalties, BaseRoyaltiesArgs, BubblegumV2, BubblegumV2Args, BurnDelegate, BurnDelegateArgs, Edition, EditionArgs, FreezeDelegate, FreezeDelegateArgs, ImmutableMetadata, ImmutableMetadataArgs, PermanentBurnDelegate, PermanentBurnDelegateArgs, PermanentFreezeDelegate, PermanentFreezeDelegateArgs, PermanentTransferDelegate, PermanentTransferDelegateArgs, TransferDelegate, TransferDelegateArgs, UpdateDelegate, UpdateDelegateArgs, VerifiedCreators, VerifiedCreatorsArgs } from '.';
export type Plugin = {
    __kind: 'Royalties';
